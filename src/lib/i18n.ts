...
export const dict: Record<Lang, Dict> = {
  ar: {
    ...
    hero: {
      ...
      subtitle:
        "مؤتمر طلّابي تنظّمه تجمّع إبتكار، يسلّط الضّوء على مواضيع مختلفة في التقنيّات الحديثة من النّاحية التّقنيّة — محاضرات نظريّة تقدّم مدخلًا في مجالات تقنية صاعدة، وورش عمل تقنية تعتبر مدخلًا لكل تقنية أو مجال.",
      register: "سجّل الآن",
