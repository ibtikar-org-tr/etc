...
export const dict2024: Record<Lang, Dict2024> = {
  ...
  tr: {
    ...
    hero: {
      ...
      attendees: "Katılımcı",
      attendeesValue: "250 öğrenci + misafir",
      days: "Süre",
      daysValue: "2 gün",
    },
    about: {
      ...
      stats: [
        { value: "250+", label: "öğrenci ve misafir" },
  ...
  en: {
    ...
    hero: {
      ...
      attendees: "Attendees",
      attendeesValue: "250 students + guests",
      days: "Duration",
      daysValue: "2 days",
    },
    about: {
      ...
      stats: [
        { value: "250+", label: "students & guests" },
