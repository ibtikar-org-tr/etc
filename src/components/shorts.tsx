    ...
    <section className="border-t border-border py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          <p className="anim-label font-mono text-xs uppercase tracking-widest text-primary">{s.label}</p>
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {s.items.map((item) => (
            <div
              key={item.title}
              className="anim-card rounded-2xl border border-border bg-card/50 p-5 transition-colors hover:border-primary/40"
            >
