...
import { normalizeToAsciiLower } from '@/lib/normalize-text'
...
export function PhoneNumberField({ value, onChange, required = false, label = 'رقم الهاتف' }: PhoneNumberFieldProps) {
