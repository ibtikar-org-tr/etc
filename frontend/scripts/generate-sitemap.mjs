...
const pages = ["", "/2024", "/etc-2024", "/2026/startups", "/2026/qr", "/2026/certificate"]

const urls = pages.flatMap((page) =>
  langs.map((lang) => {
    const loc = `${origin}/${lang}${page}`
    const priority =
      page === "" ? (lang === "ar" ? "1.0" : "0.9") : page === "/2026/startups" ? "0.8" : page === "/2026/qr" || page === "/2026/certificate" ? "0.5" : page === "/2024" ? "0.7" : "0.6"
    const changefreq =
      page === "" ? "weekly" : page === "/2026/startups" || page === "/2024" ? "weekly" : page === "/2026/qr" || page === "/2026/certificate" ? "monthly" : "monthly"
    return `  <url>
    <loc>${loc}</loc>
